...
<Steps>
  <Step title="Get a config for your robot">
    Robots that speak ROS 2 start from a pre-filled template — pick your robot's shape and fill in the marked fields: [Set up your config](/integration/configuration). Supported hardware has ready-made configs — see [Example configs](/configuration/examples). The [configuration reference](/configuration/reference) explains every section.
  </Step>
