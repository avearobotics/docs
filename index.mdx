...
- **Robots that speak ROS 2** connect over a few standard topics — most `ros2_control` setups already expose them. Copy a pre-filled config and fill in the marked fields. See [Connect over ROS 2](/integration/overview).
