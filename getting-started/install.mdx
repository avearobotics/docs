...
- [AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) — install it through snap or the official installer
...
<Card title="Set up a robot" icon="robot" href="/getting-started/choose-path" horizontal>
  Choose a supported integration or connect a robot through ROS 2, then generate the robot configuration.
</Card>
