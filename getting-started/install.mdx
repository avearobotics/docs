...
<Columns cols={2}>
  ...
  <Card title="Add an immersive neck" icon="rotate" href="/hardware/immersive-neck">
    Use the launcher's optional calibration-file argument for a head-tracked camera neck.
  </Card>
</Columns>
