...
<Note>
  Every button can be remapped. Mappings live in your config file, and the defaults below are a starting point. If you want a different button to arm the robot, start teleop, switch cameras, or run one of your own actions, tell us and we'll change it.
</Note>
...
Let go and the arm stops following right away. In [state machine](/concepts/state-machine) terms: squeezing moves the robot to **teleop active**, releasing returns it to **armed**.
...
<CardGroup cols={2}>
  ...
  <Card title="Set up your config" icon="file-pen" href="/integration/configuration">
