...
Sentinel always knows what mode your robot is in, and that mode decides whether commands reach your motors. This answers the main question you'll have when setting up your robot: **when should it act on commands?**

The short answer: **only during teleoperation.** In every other mode your robot holds still, even when it's powered and ready.
