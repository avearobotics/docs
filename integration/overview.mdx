...
This section covers what your robot publishes and subscribes to — the topics, message types, units, and rates. You can set this up and test it on your own before we connect anything.
