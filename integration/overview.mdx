...
<Note>
  **Got more than an arm?** Mobile base, camera neck, and PTZ are fully supported, and the pattern is the same as everything else — standard ROS 2 topics, with the exact messages agreed with us. Have something not in this list? [Talk to us on Slack](https://avearobotics.com/slack) and we'll define the contract with you and add it to your config.
</Note>
