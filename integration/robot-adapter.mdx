...
<Tip>
  Already running `ros2_control`, MoveIt, or your own joint controller? You don't need to replace it. As long as something on your robot takes a `JointTrajectory` and publishes `JointState`, it works. Tell us your setup and we'll match it.
</Tip>
